...
{
    public class ShareDividendPatronizeTransferredRequestDto
    {
        public string? FromDateBs { get; set; }
        public string? ToDateBs { get; set; }
        public string ReportType { get; set; } = "SHARE_DIVIDEND";
        public bool VisualReport { get; set; } = false;
    }

    public class ShareDividendPatronizeTransferredRowDto
    {
    ...
    public class ShareDividendPatronizeTransferredData
    {
        public List<ShareDividendPatronizeTransferredRowDto> Rows { get; set; } = [];
