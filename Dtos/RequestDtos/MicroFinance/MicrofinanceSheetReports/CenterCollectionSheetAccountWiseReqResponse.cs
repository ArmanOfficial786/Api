// Dtos/RequestDtos/Microfinance/MicrofinanceSheetReports/CenterCollectionSheetAccountWiseRequestDto.cs
namespace NexgenCosysReport.Dtos.RequestDtos.Microfinance.MicrofinanceSheetReports
{
    public class CenterCollectionSheetAccountWiseRequestDto
    {
    ...
    // Result set 1: Member + Loan summary columns
    public class CenterCollectionSheetAccountMemberDto
    {
    ...
    public class CenterCollectionSheetAccountReceivableDto
    {
        public string? GroupCode { get; set; }
        public string? GroupName { get; set; }
        public long? MemMemberRegistrationId { get; set; }
    ...
    public class CenterCollectionSheetAccountSavingSummaryDto
    {
    ...
    public class CenterCollectionSheetAccountLoanSummaryDto
    {
    ...
    public class CenterCollectionSheetAccountEvaluationDto
    {
    ...
    public class CenterCollectionSheetAccountWiseData
    {
        public List<CenterCollectionSheetAccountMemberDto> Members { get; set; } = [];
        public List<CenterCollectionSheetAccountReceivableDto> Receivables { get; set; } = [];
        public List<CenterCollectionSheetAccountSavingSummaryDto> SavingSummary { get; set; } = [];
        public List<CenterCollectionSheetAccountLoanSummaryDto> LoanSummary { get; set; } = [];
        public CenterCollectionSheetAccountEvaluationDto? Evaluation { get; set; }
