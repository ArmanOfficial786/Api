// Dtos/RequestDtos/Microfinance/MicrofinanceReport/LoanTypeWiseRequestDto.cs
namespace NexgenCosysReport.Dtos.RequestDtos.MicroFinance.MicroFinanceReports
{
    public class LoanTypeWiseRequestDto
    {
        ...
        public string ShareType { get; set; } = "-1";
    ...
    public class LoanTypeWiseData
    {
        ...
        public decimal TotalOpeningDisburseAmount { get; set; }
