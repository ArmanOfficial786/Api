namespace NexgenCosysReport.Dtos.RequestDtos.MemberAccount.OthersReport
{
    ...
    public class SavingDepositDateWiseRequestDto
    {
        ...
        public int ChequeDetail { get; set; } = -1; // -1=All, 1=Only Cheque, 2=Cash Only, 3=Bank Only
    }

    public class SavingDepositDateWiseRowDto
    {
        ...
        public string? PaymentMode { get; set; } // Cheque, Cash, Bank
    }

    public class SavingDepositDateWiseData
    {
        public List<SavingDepositDateWiseRowDto> Rows { get; set; } = new();
        ...
        public int ChequeDetail { get; set; }
        public string? ChequeDetailText { get; set; }
    }

    public class SavingDepositDateWiseReqResponse
    {
    }
}
