// Dtos/RequestDtos/Loan/LoanAnalysisReport/CollectorWiseLoanAnalysisRequestDto.cs
namespace NexgenCosysReport.Dtos.RequestDtos.Loan.LoanAnalysisReport
{
    public class CollectorWiseLoanAnalysisRequestDto
    {
        ...
        public string PenaltyType { get; set; } = "S"; // S = Schedule Wise, R = Remaining Principle, A = After Maturity
        public string OrderBy { get; set; } = "-1";
        public bool EnableCollectionCenter { get; set; } = false;
        public string ReportMode { get; set; } = "1"; // "1" = Summary, "0" = Detail
