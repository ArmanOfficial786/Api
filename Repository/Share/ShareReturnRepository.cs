...
{
    public class ShareReturnRepository : IShareReturn
    {
        private readonly AppDbContext _context;
        private readonly IDateConverterService _dateConverter;
        private readonly ILogger<ShareReturnRepository> _logger;

        public ShareReturnRepository(
            AppDbContext context,
            IDateConverterService dateConverter,
            ILogger<ShareReturnRepository> logger)
        {
            _context = context;
        ...
        private static string BuildSqlOrderBy(ShareReturnRequestDto request)
        {
            ...
            return request.OrderBy.Trim() switch
            {
                ...
                "ReturnDate" => " order by ReturnDate ",
        ...
        public async Task<ShareReturnData> GetReportDataAsync(ShareReturnRequestDto request)
        {
            try
            {
                ...
                var rows = await connection.QueryAsync<ShareReturnRowDto>(
                    "sp_8_14_GetShareReturn",
                    parameters,
