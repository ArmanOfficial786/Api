...
{
    public class SharePurchaseRepository : ISharePurchase
    {
        private readonly AppDbContext _context;
        private readonly IDateConverterService _dateConverter;
        private readonly ILogger<SharePurchaseRepository> _logger;

        public SharePurchaseRepository(
            AppDbContext context,
            IDateConverterService dateConverter,
            ILogger<SharePurchaseRepository> logger)
        {
            _context = context;
        ...
        private static string BuildSqlOrderBy(SharePurchaseRequestDto request)
        {
        ...
        public async Task<SharePurchaseData> GetReportDataAsync(SharePurchaseRequestDto request)
        {
            try
            {
                ...
                var rows = await connection.QueryAsync<SharePurchaseRowDto>(
                    "sp_8_14_GetSharePurchase",
                    parameters,
