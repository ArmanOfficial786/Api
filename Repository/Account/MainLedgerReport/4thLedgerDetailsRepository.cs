// Repositories/Implementations/Account/LedgerDetailsRepository.cs
using Dapper;
...
{
    public class LedgerDetailsRepository : I4thLedgerDetailsRepository
    {
        ...
        public LedgerDetailsRepository(
            ...
            ILogger<LedgerDetailsRepository> logger)
        {
            _context = context;
        ...
        private static string BuildSqlOrderBy(LedgerDetailsReqResponse request)
        {
        ...
        public async Task<LedgerDetailsData> GetReportDataAsync(LedgerDetailsReqResponse request)
        {
            try
            {
