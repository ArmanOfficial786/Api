...
namespace NexgenCosysReport.Controllers.Share
{
    ...
    [Authorize]
    public class ShareTransferController : ControllerBase
    {
        private readonly IShareTransfer _repository;
        ...
        public async Task<IActionResult> GenerateReport(
            [FromBody] ShareTransferRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                string viewPath = request.VisualReport
                    ? "Views/VisualReport/VShareTransferReport.cshtml"
                    : "Views/Report/Share/ShareTransferReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Error generating ShareTransfer report");
