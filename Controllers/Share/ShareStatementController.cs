...
namespace NexgenCosysReport.Controllers.Share
{
    ...
    [Authorize]
    public class ShareStatementController : ControllerBase
    {
        private readonly IShareStatement _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<ShareStatementController> _logger;
        private readonly IDateConverterService _dateConverter;

        public ShareStatementController(
            IShareStatement repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<ShareStatementController> logger,
        ...
        public async Task<IActionResult> GenerateReport(
            [FromBody] ShareStatementRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportData = new Dictionary<string, object>
                {
                    ...
                    { "TotalPurchasedAmount", data.TotalPurchasedAmount },
                    ...
                    { "EnableHeader", request.EnableHeader },
                    { "EnableBillNo", request.EnableBillNo },
                    { "Format", upperFormat }
                };

                string viewPath = request.VisualReport
                    ? "Views/VisualReport/VShareStatementReport.cshtml"
                    : "Views/Report/Share/ShareStatementReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Error generating ShareStatement report");
