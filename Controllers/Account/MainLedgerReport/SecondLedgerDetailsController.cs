// Controllers/Account/SecondLedgerDetailsReport/SecondLedgerDetailsController.cs
...
namespace NexgenCosysReport.Controllers.Account.SecondLedgerDetailsReport
{
    ...
    {
        private readonly ISecondLedgerDetailsRepository _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<SecondLedgerDetailsController> _logger;

        public SecondLedgerDetailsController(
            ISecondLedgerDetailsRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<SecondLedgerDetailsController> logger)
        {
        ...
        public async Task<IActionResult> GenerateReport(
            [FromBody] SecondLedgerDetailsRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportName = "SecondLedgerDetails";
                ...
                // Get report data
                var data = await _repository.GetSecondLedgerDetailsDataAsync(request);
                ...
                var reportData = new Dictionary<string, object>
                {
                    ...
                    { "SecondSubLedgerName", data.SecondSubLedgerName },
                    { "VoucherType", data.VoucherType },
                    { "ReportType", data.ReportType },
                    { "ShowOpeningBalance", data.ShowOpeningBalance },
                    { "OrderBy", data.OrderBy },
                    { "LedgerHeadName", data.LedgerHeadName },
                ...
                string viewPath = request.VisualReport
                    ? "Views/VisualReport/VSecondLedgerDetailsReport.cshtml"
            ...
            {
                _logger.LogError(ex, "Error generating Second Ledger Details Report");
