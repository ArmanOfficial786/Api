// Controllers/Account/OthersReport/DayBookLedgerWiseController.cs
...
namespace NexgenCosysReport.Controllers.Account.OthersReport
{
    ...
    [Authorize]
    public class DayBookLedgerWiseController : ControllerBase
    {
        private readonly IDayBookLedgerWiseRepository _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<DayBookLedgerWiseController> _logger;
        private readonly IDateConverterService _dateConverter;

        public DayBookLedgerWiseController(
            IDayBookLedgerWiseRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<DayBookLedgerWiseController> logger,
        ...
        public async Task<IActionResult> GenerateReport(
            [FromBody] DayBookLedgerWiseRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportName = "DayBookLedgerWise";
                ...
                // Get report data
                var data = await _repository.GetDayBookLedgerWiseDataAsync(request);
            ...
            {
                _logger.LogError(ex, "Error generating Day Book Ledger Wise Report");
