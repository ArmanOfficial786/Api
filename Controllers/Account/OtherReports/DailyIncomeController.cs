...
namespace NexgenCosysReport.Controllers.Account.OthersReport
{
    ...
    public class DailyIncomeController : ControllerBase
    {
        ...
        private readonly ILogger<DailyIncomeController> _logger;

        public DailyIncomeController(
            IDailyIncomeRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<DailyIncomeController> logger)
        {
        ...
        public async Task<IActionResult> GenerateReport(
            [FromBody] DailyIncomeRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                // Get report data
                var data = await _repository.GetDailyIncomeDataAsync(request);
            ...
            {
                _logger.LogError(ex, "Error generating Daily Income Report");
