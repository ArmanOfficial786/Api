...
namespace NexgenCosysReport.Controllers.Account.OthersReport
{
    ...
    public class PaymentThroughSavingController : ControllerBase
    {
        ...
        private readonly ILogger<PaymentThroughSavingController> _logger;
        private readonly IDateConverterService _dateConverter;

        public PaymentThroughSavingController(
            IPaymentThroughSavingRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<PaymentThroughSavingController> logger,
        ...
        // POST api/PaymentThroughSaving?format=VIEW
        [HttpPost()]
        public async Task<IActionResult> GenerateReport(
            [FromBody] PaymentThroughSavingRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            ...
            {
                _logger.LogError(ex, "Error generating PaymentThroughSaving report");
