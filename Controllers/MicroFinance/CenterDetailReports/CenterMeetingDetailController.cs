// Controllers/Microfinance/CenterDetailReports/CenterMeetingDetailController.cs
...
namespace NexgenCosysReport.Controllers.Microfinance.CenterDetailReports
{
    ...
    [Authorize]
    public class CenterMeetingDetailController : ControllerBase
    {
        private readonly ICenterMeetingDetailRepository _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<CenterMeetingDetailController> _logger;

        public CenterMeetingDetailController(
            ICenterMeetingDetailRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<CenterMeetingDetailController> logger)
        {
        ...
        public async Task<IActionResult> GenerateReport(
            [FromBody] CenterMeetingDetailRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportName = "CenterMeetingDetail";
                ...
                var reportData = new Dictionary<string, object>
                {
                    ...
                    { "MeetingType", data.MeetingType ?? "rbNext" },
                    { "MeetingTypeName", data.MeetingTypeName ?? "Next Meeting" },
                    { "Format", upperFormat }
                };

                string viewPath = request.VisualReport
                    ? "Views/VisualReport/Microfinance/VCenterMeetingDetailReport.cshtml"
                    : "Views/Report/Microfinance/CenterDetailReports/CenterMeetingDetailReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Error generating CenterMeetingDetail report");
