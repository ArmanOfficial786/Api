// Controllers/Microfinance/MicrofinanceReport/GroupWiseMemberAccountDetailsController.cs
...
namespace NexgenCosysReport.Controllers.Microfinance.MicrofinanceReport
{
    ...
    [Authorize]
    public class GroupWiseMemberAccountDetailsController : ControllerBase
    {
        private readonly IGroupWiseMemberAccountDetailsRepository _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<GroupWiseMemberAccountDetailsController> _logger;

        public GroupWiseMemberAccountDetailsController(
            IGroupWiseMemberAccountDetailsRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<GroupWiseMemberAccountDetailsController> logger)
        {
        ...
        public async Task<IActionResult> GenerateReport(
            [FromBody] GroupWiseMemberAccountDetailsRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportName = "GroupWiseMemberAccountDetails";
            ...
            {
                _logger.LogError(ex, "Error generating GroupWiseMemberAccountDetails report");
