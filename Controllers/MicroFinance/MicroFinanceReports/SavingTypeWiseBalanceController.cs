// Controllers/Microfinance/MicrofinanceReport/SavingTypeWiseBalanceController.cs
...
namespace NexgenCosysReport.Controllers.Microfinance.MicrofinanceReport
{
    ...
    {
        private readonly ISavingTypeWiseBalanceRepository _repository;
        ...
        public SavingTypeWiseBalanceController(
            ISavingTypeWiseBalanceRepository repository,
        ...
        public async Task<IActionResult> GenerateReport(
            [FromBody] SavingTypeWiseBalanceRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportData = new Dictionary<string, object>
                {
                    ...
                    { "OrderBy", data.OrderBy ?? "SavingType" },
                ...
                string viewPath = request.VisualReport
                    ? "Views/VisualReport/Microfinance/VSavingTypeWiseBalanceReport.cshtml"
                    : (request.NepaliReport
                        ? "Views/Report/Microfinance/MicrofinanceReport/SavingTypeWiseBalanceNepaliReport.cshtml"
            ...
            {
                _logger.LogError(ex, "Error generating SavingTypeWiseBalance report");
