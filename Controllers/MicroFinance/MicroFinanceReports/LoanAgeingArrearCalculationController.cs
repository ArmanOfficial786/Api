// Controllers/Microfinance/MicrofinanceReport/LoanAgeingArrearCalculationController.cs
...
namespace NexgenCosysReport.Controllers.Microfinance.MicrofinanceReport
{
    ...
    [Authorize]
    public class LoanAgeingArrearCalculationController : ControllerBase
    {
        private readonly ILoanAgeingArrearCalculationRepository _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<LoanAgeingArrearCalculationController> _logger;

        public LoanAgeingArrearCalculationController(
            ILoanAgeingArrearCalculationRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<LoanAgeingArrearCalculationController> logger)
        {
        ...
        public async Task<IActionResult> GenerateReport(
            [FromBody] LoanAgeingArrearCalculationRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportName = "LoanAgeingArrearCalculation";
                ...
                var reportData = new Dictionary<string, object>
                {
                    ...
                    { "TotalPrinciplePaidAmount", data.TotalPrinciplePaidAmount },
                    { "TotalLoanBalance", data.TotalLoanBalance },
                    { "TotalGoodLoan", data.TotalGoodLoan },
                    { "TotalBetween0to30Days", data.TotalBetween0to30Days },
                    { "TotalBetween31to365Days", data.TotalBetween31to365Days },
                    { "TotalGraterThan365Days", data.TotalGraterThan365Days },
                ...
                string viewPath = request.VisualReport
                    ? "Views/VisualReport/Microfinance/VLoanAgeingArrearCalculationReport.cshtml"
            ...
            {
                _logger.LogError(ex, "Error generating LoanAgeingArrearCalculation report");
