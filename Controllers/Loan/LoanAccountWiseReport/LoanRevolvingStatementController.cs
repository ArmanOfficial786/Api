...
namespace NexgenCosysReport.Controllers.Loan.OtherReports
{
    ...
    [Authorize]
    public class LoanRevolvingStatementController : ControllerBase
    {
        private readonly ILoanRevolvingStatementRepository _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<LoanRevolvingStatementController> _logger;
        private readonly IDateConverterService _dateConverter;

        public LoanRevolvingStatementController(
            ILoanRevolvingStatementRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<LoanRevolvingStatementController> logger,
        ...
        public async Task<IActionResult> GenerateReport(
            [FromBody] LoanRevolvingStatementRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportName = "LoanRevolvingStatement";
                ...
                string viewPath = request.VisualReport ? "Views/VisualReport/Account/VAccountStatementReport.cshtml"
                    : "Views/Report/Loan/LoanAccountWiseReport/LoanRevolvingStatementReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Error generating LoanRevolvingStatement report");
