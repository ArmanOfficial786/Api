...
namespace NexgenCosysReport.Controllers.Loan.OtherReports
{
    ...
    public class MiscellaneousIncomeController : ControllerBase
    {
        ...
        // POST api/MiscellaneousIncome?format=VIEW
            ...
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                string viewPath = "Views/Report/Loan/OtherReports/MiscellaneousIncomeReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Error generating MiscellaneousIncome report");
