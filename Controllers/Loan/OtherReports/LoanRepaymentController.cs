...
namespace NexgenCosysReport.Controllers.Loan.OtherReports
{
    ...
    public class LoanRepaymentController : ControllerBase
    {
        ...
        private readonly ILogger<LoanRepaymentController> _logger;
        ...
        public LoanRepaymentController(
            ...
            ILogger<LoanRepaymentController> logger,
            ...
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportData = new Dictionary<string, object>
                {
                    ...
                    { "TotalPrincipleBalance", data.TotalPrincipleBalance },
