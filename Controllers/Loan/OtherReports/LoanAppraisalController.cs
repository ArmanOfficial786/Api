// Controllers/Loan/OtherReports/LoanAppraisalController.cs
...
namespace NexgenCosysReport.Controllers.Loan.OtherReports
{
    ...
    //[Authorize]
    public class LoanAppraisalController : ControllerBase
    {
        private readonly ILoanAppraisalRepository _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<LoanAppraisalController> _logger;
        private readonly IDateConverterService _dateConverter;

        public LoanAppraisalController(
            ILoanAppraisalRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<LoanAppraisalController> logger,
        ...
        // POST api/LoanAppraisal?format=VIEW
        // Body: { "memberId": "M-001", "branchIds": "1,2", "visualReport": false }
        [HttpPost()]
        public async Task<IActionResult> GenerateReport(
            [FromBody] LoanAppraisalRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                {
                    // Mirrors legacy: txtMemberId.Text check before BtnViewReport_Click proceeds
                ...
                var reportData = new Dictionary<string, object>
                {
                    ...
                    { "TotalCollateralAmount", data.TotalCollateralAmount },
                    { "TotalCollateralSanctionAmount", data.TotalCollateralSanctionAmount },
                ...
                string viewPath = "Views/Report/Loan/OtherReports/LoanAppraisalReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Error generating LoanAppraisal report");
