...
namespace NexgenCosysReport.Controllers.Loan.OtherReports
{
    ...
    public class LoanGuaranteerController : ControllerBase
    {
        ...
        private readonly ILogger<LoanGuaranteerController> _logger;
        private readonly IDateConverterService _dateConverter;

        public LoanGuaranteerController(
            ILoanGuaranteerRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<LoanGuaranteerController> logger,
            ...
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportData = new Dictionary<string, object>
                {
                    ...
                    { "TotalGuaranteeAmount", data.TotalGuaranteeAmount },
                    { "TotalGuaranteeShareAmount", data.TotalGuaranteeShareAmount },
