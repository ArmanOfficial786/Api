...
namespace NexgenCosysReport.Controllers.Loan.OtherReports
{
    ...
    public class LoanCommissionController : ControllerBase
    {
        ...
        private readonly ILogger<LoanCommissionController> _logger;
        private readonly IDateConverterService _dateConverter;

        public LoanCommissionController(
            ILoanCommissionRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<LoanCommissionController> logger,
            ...
            [FromQuery] string format = "VIEW")
        {
            ...
            {
                _logger.LogError(ex, "Error generating LoanCommission report");
