// Controllers/AccountOperation/SMSCategoryController.cs
...
namespace NexgenCosysReport.Controllers.MembeAccount.SavingAccWiseReport
{
    ...
    public class SMSCategoryController : ControllerBase
    {
        private readonly ISMSCategory _smsCategoryService;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<SMSCategoryController> _logger;

        public SMSCategoryController(
            ISMSCategory smsCategoryService,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<SMSCategoryController> logger)
        {
            _smsCategoryService = smsCategoryService;
        ...
        public async Task<IActionResult> GenerateReport(
            [FromBody] SMSCategoryRequest request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                var reportName = "SMSCategory";
                ...
                // Fetch data
                var dataTask = _smsCategoryService.GetSMSCategory(request);
                ...
                var reportData = new Dictionary<string, object>
                {
                    ...
                    { "SmsCategoryId", request.SmsCategoryId },
            ...
            {
                _logger.LogError(ex, "SMSCategory report generation failed");
