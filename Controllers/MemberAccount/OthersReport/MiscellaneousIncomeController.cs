    ...
    public class MiscellaneousIncomeController : ControllerBase
    {
            ...
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportName = "MiscellaneousIncome";
                ...
                if (!data.Rows.Any())
                {
                    return NotFound(new GeneralResponse<ReportResponseDtos>
                    {
                        isValid = false,
                        statusCode = 404,
                        message = "No miscellaneous income transactions found for the selected criteria"
                    });
                }
                ...
                string viewPath = request.VisualReport
                    ? "Views/VisualReport/VMiscellaneousIncomeReport.cshtml"
                    : "Views/Report/MemberAC/MiscellaneousIncomeReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Miscellaneous Income report generation failed");
