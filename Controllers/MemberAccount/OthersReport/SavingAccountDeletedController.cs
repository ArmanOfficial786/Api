// Controllers/MemberAccount/OthersReport/SavingAccountDeletedController.cs
...
namespace NexgenCosysReport.Controllers.MemberAccount.OthersReport
{
    ...
    [Authorize]
    public class SavingAccountDeletedController : ControllerBase
    {
        private readonly ISavingAccountDeletedRepository _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<SavingAccountDeletedController> _logger;
        private readonly IDateConverterService _dateConverter;

        public SavingAccountDeletedController(
            ISavingAccountDeletedRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<SavingAccountDeletedController> logger,
        ...
        public async Task<ActionResult<GeneralResponse<ReportResponseDtos>>> GenerateReport(
            [FromBody] SavingAccountDeletedRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportName = "SavingAccountDeleted";
                ...
                if (!data.Rows.Any())
                {
                    return NotFound(new GeneralResponse<ReportResponseDtos>
                    {
                        isValid = false,
                        statusCode = 404,
                        message = "No deleted saving accounts found for the selected criteria"
                    });
                }
                ...
                var reportData = new Dictionary<string, object>
                {
                    ...
                    { "TotalDeletedAccounts", data.TotalDeletedAccounts }
                };

                string viewPath = request.VisualReport
                    ? "Views/VisualReport/VSavingAccountDeletedReport.cshtml"
                    : "Views/Report/MemberAC/SavingAccountDeletedReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Saving Account Deleted report generation failed");
