...
namespace NexgenCosysReport.Controllers.MemberAccount.OthersReport
{
    ...
    public class SavingAccountRenewedController : ControllerBase
    {
            ...
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                if (!data.Rows.Any())
                {
                    return NotFound(new GeneralResponse<ReportResponseDtos>
                    {
                        isValid = false,
                        statusCode = 404,
                        message = "No renewed saving accounts found for the selected criteria"
                    });
                }
                ...
                string viewPath = request.VisualReport
                    ...
                    : "Views/Report/MemberAC/SavingAccountRenewedReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Saving Account Renewed report generation failed");
