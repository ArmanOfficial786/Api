...
namespace NexgenCosysReport.Controllers.MemberAccount.OthersReport
{
    ...
    [Authorize]
    public class SavingDepositDateWiseController : ControllerBase
    {
        ...
        private readonly ILogger<SavingDepositDateWiseController> _logger;
        private readonly IDateConverterService _dateConverter;

        public SavingDepositDateWiseController(
            ...
            ILogger<SavingDepositDateWiseController> logger,
            ...
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                // Validate request - DateWise mode requires dates
                ...
                string viewPath = request.VisualReport
                    ...
                    : "Views/Report/MemberAC/SavingDepositDateWiseReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Saving Deposit Date Wise report generation failed");
