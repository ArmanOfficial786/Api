// Controllers/MemberAccount/InterestExpenseReport/InterestAndTaxPostedController.cs
...
namespace NexgenCosysReport.Controllers.MemberAccount.InterestExpenseReport
{
    ...
    [Authorize]
    public class InterestAndTaxPostedController : ControllerBase
    {
        private readonly IInterestAndTaxPostedRepository _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<InterestAndTaxPostedController> _logger;
        private readonly IDateConverterService _dateConverter;

        public InterestAndTaxPostedController(
            IInterestAndTaxPostedRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<InterestAndTaxPostedController> logger,
        ...
        public async Task<ActionResult<GeneralResponse<ReportResponseDtos>>> GenerateReport(
            [FromBody] InterestAndTaxPostedRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportName = "InterestAndTaxPosted";
                ...
                if (!data.Rows.Any())
                {
                    return NotFound(new GeneralResponse<ReportResponseDtos>
                    {
                        isValid = false,
                        statusCode = 404,
                        message = "No interest and tax posted records found for the selected criteria"
                    });
                }
                ...
                string viewPath = request.VisualReport
                    ? "Views/VisualReport/VInterestAndTaxPostedReport.cshtml"
                    : "Views/Report/MemberAC/InterestAndTaxPostedReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Interest and Tax Posted report generation failed");
