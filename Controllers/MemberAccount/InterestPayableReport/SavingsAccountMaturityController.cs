// Controllers/MemberAccount/SavingsAccountMaturityReport/SavingsAccountMaturityController.cs
...
namespace NexgenCosysReport.Controllers.MemberAccount.SavingsAccountMaturityReport
{
    ...
    public class SavingsAccountMaturityController : ControllerBase
    {
            ...
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                if (!data.Rows.Any())
                {
                    return NotFound(new GeneralResponse<ReportResponseDtos>
                    {
                        isValid = false,
                        statusCode = 404,
                        message = "No savings account maturity records found for the selected criteria"
                    });
                }
            ...
            {
                _logger.LogError(ex, "Savings Account Maturity report generation failed");
