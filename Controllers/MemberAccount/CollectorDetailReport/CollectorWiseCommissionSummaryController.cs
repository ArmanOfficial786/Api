...
namespace NexgenCosysReport.Controllers.MemberAccount.CollectorDetailReport
{
    ...
    public class CollectorWiseCommissionSummaryController : ControllerBase
    {
            ...
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                if (!data.Rows.Any())
                {
                    return NotFound(new GeneralResponse<ReportResponseDtos>
                    {
                        isValid = false,
                        statusCode = 404,
                        message = "No commission summary found for the selected criteria"
                    });
                }
                ...
                string viewPath = request.VisualReport
                    ...
                    : "Views/Report/MemberAC/CollectorWiseCommissionSummaryReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Collector Wise Commission Summary report generation failed");
