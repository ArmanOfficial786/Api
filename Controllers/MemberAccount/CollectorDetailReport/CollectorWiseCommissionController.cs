// Controllers/MemberAccount/CollectorDetailReport/CollectorWiseCommissionController.cs
...
namespace NexgenCosysReport.Controllers.MemberAccount.CollectorDetailReport
{
    ...
    [Authorize]
    public class CollectorWiseCommissionController : ControllerBase
    {
        private readonly ICollectorWiseCommissionRepository _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<CollectorWiseCommissionController> _logger;
        private readonly IDateConverterService _dateConverter;

        public CollectorWiseCommissionController(
            ICollectorWiseCommissionRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<CollectorWiseCommissionController> logger,
        ...
        public async Task<ActionResult<GeneralResponse<ReportResponseDtos>>> GenerateReport(
            [FromBody] CollectorWiseCommissionRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportName = "CollectorWiseCommission";
                ...
                if (!data.Rows.Any())
                {
                    return NotFound(new GeneralResponse<ReportResponseDtos>
                    {
                        isValid = false,
                        statusCode = 404,
                        message = "No commission transactions found for the selected criteria"
                    });
                }
            ...
            {
                _logger.LogError(ex, "Collector Wise Commission report generation failed");
