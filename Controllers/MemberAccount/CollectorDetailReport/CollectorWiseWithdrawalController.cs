// Controllers/MemberAccount/CollectorDetailReport/CollectorWiseWithdrawalController.cs
...
namespace NexgenCosysReport.Controllers.MemberAccount.CollectorDetailReport
{
    ...
    [Authorize]
    public class CollectorWiseWithdrawalController : ControllerBase
    {
        private readonly ICollectorWiseWithdrawalRepository _repository;
        private readonly ICommonHeaderRepository _commonHeaderRepository;
        private readonly IJsReportService _jsReportService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly CustomHeaderResponse _headerResponse;
        private readonly IOptions<ReportSettings> _reportSettings;
        private readonly ILogger<CollectorWiseWithdrawalController> _logger;
        private readonly IDateConverterService _dateConverter;

        public CollectorWiseWithdrawalController(
            ICollectorWiseWithdrawalRepository repository,
            ICommonHeaderRepository commonHeaderRepository,
            IJsReportService jsReportService,
            IWebHostEnvironment webHostEnvironment,
            CustomHeaderResponse headerResponse,
            IOptions<ReportSettings> reportSettings,
            ILogger<CollectorWiseWithdrawalController> logger,
        ...
        public async Task<ActionResult<GeneralResponse<ReportResponseDtos>>> GenerateReport(
            [FromBody] CollectorWiseWithdrawalRequestDto request,
            [FromQuery] string format = "VIEW")
        {
            try
            {
                ...
                var reportName = "CollectorWiseWithdrawal";
                ...
                if (!data.Rows.Any())
                {
                    return NotFound(new GeneralResponse<ReportResponseDtos>
                    {
                        isValid = false,
                        statusCode = 404,
                        message = "No withdrawal transactions found for the selected criteria"
                    });
                }
                ...
                string viewPath = request.VisualReport
                    ? "Views/VisualReport/VCollectorWiseWithdrawalReport.cshtml"
                    : "Views/Report/MemberAC/CollectorWiseWithdrawalReport.cshtml";
            ...
            {
                _logger.LogError(ex, "Collector Wise Withdrawal report generation failed");
